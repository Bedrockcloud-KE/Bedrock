...
class ApplicationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Application::create([
            ...
            'git_repository' => 'coollabsio/bedrock-examples',
            'git_branch' => 'v4.x',
...
',
        ...
        Application::create([
            ...
            'git_repository' => 'git@github.com:coollabsio/bedrock-examples-deploy-key.git',
            'git_branch' => 'main',
            'build_pack' => 'nixpacks',
            'ports_exposes' => '80',
            'environment_id' => 1,
        ...
        Application::create([
            ...
            'git_repository' => 'https://gitlab.com/andrasbacsai/bedrock-examples.git',
