...
[FILTER]
    Name                modify
    Match               *
    Set                 bedrock.server_name {$server->name}
    Rename              COOLIFY_APP_NAME bedrock.app_name
    Rename              COOLIFY_PROJECT_NAME bedrock.project_name
    Rename              COOLIFY_SERVER_IP bedrock.server_ip
    Rename              COOLIFY_ENVIRONMENT_NAME bedrock.environment_name
[OUTPUT]
    Name nrlogs
    Match *
...
services:
  bedrock-log-drain:
    ...
    container_name: bedrock-log-drain
