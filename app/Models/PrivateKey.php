...
class PrivateKey extends BaseModel
{
    ...
    public static function generateNewKeyPair($type = 'rsa')
    {
        try {
            ...
            $description = 'Created by Bedrock';
    ...
    protected function ensureStorageDirectoryExists()
    {
        ...
        if (! $testSuccess) {
            throw new \Exception('SSH keys storage directory is not writable. Run on the host: sudo chown -R 9999 /data/bedrock/ssh && sudo chmod -R 700 /data/bedrock/ssh && docker restart bedrock');
        }
