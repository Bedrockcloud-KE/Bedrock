...
#[OA\Schema(
    ...
    properties: [
        ...
        'docker_compose' => ['type' => 'string', 'description' => 'The docker-compose.yml file that is parsed and modified by Bedrock.'],
...
class Service extends BaseModel
{
    ...
    {
        $server = data_get($this, 'destination.server');
        instant_remote_process(["docker network disconnect {$this->uuid} bedrock-proxy"], $server, false);
    ...
    public function saveComposeConfigs()
    {
        ...
        $envs_from_bedrock = $this->environment_variables()->get();
        $sorted = $envs_from_bedrock->sortBy(function ($env) {
