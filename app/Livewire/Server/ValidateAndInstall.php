...
class ValidateAndInstall extends Component
{
    ...
    public function validateConnection()
    {
        ...
        if (! $this->uptime) {
            ...
            $this->error = 'Server is not reachable. Please validate your configuration and connection.<br>Check this <a target="_blank" class="text-black underline dark:text-white" href="https://bedrock.io/docs/knowledge-base/server/openssh">documentation</a> for further help. <br><br><div class="text-error">Error: '.$sanitizedError.'</div>';
            $this->server->update([
