...
class StatusChanged extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $fqdn = $this->fqdn;
        $mail->subject("Bedrock: {$this->resource_name} has been stopped");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            ...
            description: '[Open Application in Bedrock]('.$this->resource_url.')',
    ...
    {
        $message = 'Bedrock: '.$this->resource_name.' has been stopped.';
