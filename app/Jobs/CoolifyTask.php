...
use App\Actions\BedrockTask\RunRemoteProcess;
...
class BedrockTask implements ShouldBeEncrypted, ShouldQueue
{
    ...
    {
        Log::channel('scheduled-errors')->error('BedrockTask permanently failed', [
            'job' => 'BedrockTask',
