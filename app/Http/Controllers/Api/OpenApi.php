...
#[OA\Info(title: 'Bedrock', version: '0.1')]
#[OA\Server(url: 'https://app.bedrock.io/api/v1', description: 'Bedrock Cloud API. Change the host to your own instance if you are self-hosting.')]
#[OA\SecurityScheme(
    type: 'http',
    scheme: 'bearer',
...
class OpenApi
{
    ...
    // for the Bedrock API. It is not a controller and does
