...
-----END OPENSSH PRIVATE KEY-----';
    ...
    public function it_throws_exception_when_storage_directory_is_not_writable()
    {
        ...
        $this->expectException(\Exception::class);
        $this->expectExceptionMessage('SSH keys storage directory is not writable. Run on the host: sudo chown -R 9999 /data/bedrock/ssh && sudo chmod -R 700 /data/bedrock/ssh && docker restart bedrock');
