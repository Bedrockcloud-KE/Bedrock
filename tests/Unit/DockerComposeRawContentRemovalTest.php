 ...
 * while docker_compose contains all Bedrock additions (labels, environment variables, networks).
 *
 * These tests verify the fix for the issue where docker_compose_raw was being set to the
 * fully processed compose (with Bedrock labels, networks, etc.) instead of keeping it clean
