...
test('convertGitUrlsForDeployKeyAndGithubAppAndHttpUrl', function () {
    ...
    $result = convertGitUrl('andrasbacsai/bedrock-examples.git', 'deploy_key', $githubApp);
    expect($result)->toBe([
        'repository' => 'git@github.com:andrasbacsai/bedrock-examples.git',
        'port' => 22,
    ]);
...
test('convertGitUrlsForDeployKeyAndGithubAppAndSshUrl', function () {
    $githubApp = GithubApp::find(0);
    $result = convertGitUrl('git@github.com:andrasbacsai/bedrock-examples.git', 'deploy_key', $githubApp);
    expect($result)->toBe([
        'repository' => 'git@github.com:andrasbacsai/bedrock-examples.git',
        'port' => 22,
    ]);
...
test('convertGitUrlsForDeployKeyAndHttpUrl', function () {
    $result = convertGitUrl('andrasbacsai/bedrock-examples.git', 'deploy_key', null);
    expect($result)->toBe([
        'repository' => 'andrasbacsai/bedrock-examples.git',
        'port' => 22,
    ]);
});

test('convertGitUrlsForDeployKeyAndSshUrl', function () {
    $result = convertGitUrl('git@github.com:andrasbacsai/bedrock-examples.git', 'deploy_key', null);
    expect($result)->toBe([
        'repository' => 'git@github.com:andrasbacsai/bedrock-examples.git',
        'port' => 22,
    ]);
...
test('convertGitUrlsForSourceAndSshUrl', function () {
    $result = convertGitUrl('git@github.com:andrasbacsai/bedrock-examples.git', 'source', null);
    expect($result)->toBe([
        'repository' => 'git@github.com:andrasbacsai/bedrock-examples.git',
        'port' => 22,
    ]);
...
test('convertGitUrlsForSourceAndHttpUrl', function () {
    $result = convertGitUrl('andrasbacsai/bedrock-examples.git', 'source', null);
    expect($result)->toBe([
        'repository' => 'andrasbacsai/bedrock-examples.git',
        'port' => 22,
    ]);
...
test('convertGitUrlsForDeployKeyAndGithubAppWithCustomPort', function () {
    ...
    $result = convertGitUrl('andrasbacsai/bedrock-examples.git', 'deploy_key', $githubApp);
    expect($result)->toBe([
        'repository' => 'ssh://git@github.example.com:22222/andrasbacsai/bedrock-examples.git',
        'port' => '22222',
    ]);
});
...
test('convertGitUrlsForDeployKeyAndGithubAppWithCustomPortAndIpv6Host', function () {
    ...
    $result = convertGitUrl('andrasbacsai/bedrock-examples.git', 'deploy_key', $githubApp);
    expect($result)->toBe([
        'repository' => 'ssh://git@[2001:db8::10]:22222/andrasbacsai/bedrock-examples.git',
        'port' => '22222',
    ]);
});
