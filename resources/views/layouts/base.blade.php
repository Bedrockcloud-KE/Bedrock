...
<head>
    ...
    <meta name="Description" content="Bedrock: An open-source & self-hostable Heroku / Netlify / Vercel alternative" />
    <meta name="viewport" content="width=device-width,initial-scale=1" />
    ...
    <meta name="twitter:image" content="https://cdn.bedrock.cloud/assets/bedrock/og-image.png" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://bedrock.io" />
    ...
    <meta property="og:image" content="https://cdn.bedrock.cloud/assets/bedrock/og-image.png" />
    ...
    @endphp
    <title>{{ $name }}{{ $title ?? 'Bedrock' }}</title>
    @env('local')
        <link rel="icon" href="{{ asset('bedrock-logo-dev-transparent.png') }}" type="image/png" />
    @else
        <link rel="icon" href="{{ asset('bedrock-logo.svg') }}" type="image/svg+xml" />
    @endenv
    ...
    @if (config('app.name') == 'Bedrock Cloud')
        <script defer data-domain="app.bedrock.io" src="https://analytics.bedrock.cloud/js/plausible.js"></script>
    ...
    <script data-navigate-once>
        ...
        @auth
            ...
            window.Echo = new Echo({
                ...
                key: "{{ config('constants.pusher.app_key') }}" || 'bedrock',
