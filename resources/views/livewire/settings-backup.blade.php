<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for Bedrock instance.</div>
        <div>
            @if ($server->isFunctional())
                ...
                @else
                    To configure automatic backup for your Bedrock instance, you first need to add a database resource
                    into Bedrock.
                    <x-forms.button class="mt-2" wire:click="addBedrockDatabase">Configure Backup</x-forms.button>
                @endif
            @else
