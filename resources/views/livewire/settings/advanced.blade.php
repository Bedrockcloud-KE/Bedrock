    ...
    <x-slot:title>
        ...
        <div x-data="{ activeTab: window.location.hash ? window.location.hash.substring(1) : 'general' }"
            ...
            <form wire:submit='submit' class="flex flex-col w-full">
                ...
                <div class="pb-4">Advanced settings for your Bedrock instance.</div>
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="do_not_track"
                            helper="Opt out of anonymous usage tracking. When enabled, this instance will not report to bedrock.io's installation count and will not send error reports to help improve Bedrock."
                            label="Do Not Track" />
                    </div>
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_api_enabled" label="API Access"
                            helper="If enabled, authenticated requests to Bedrock's REST API will be allowed. Configure API tokens in Security > API Tokens." />
                    </div>
                    ...
                    <div class="md:w-96">
                        <x-forms.checkbox instantSave id="is_sponsorship_popup_enabled" label="Show Sponsorship Popup"
                            helper="Show monthly sponsorship reminders to support Bedrock development. Disable to hide these messages permanently." />
                    </div>
                </div>
                <div class="flex flex-col gap-1">
