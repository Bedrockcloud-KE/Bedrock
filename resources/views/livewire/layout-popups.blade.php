                ...
                if (window.Echo) {
                    if (window.Echo.connector.pusher.connection.state === 'connected') {
                        ...
                        if (checkNumber > 5) {
                            ...
                            console.error(
                                'Bedrock could not connect to its real-time service. This will cause unusual problems on the UI if not fixed! Please check the related documentation (https://bedrock.io/docs/knowledge-base/cloudflare/tunnels/overview) or get help on Discord (https://bedrock.cloud/discord).)'
                            );
                        }
                ...
                <x-popup>
                    ...
                    <x-slot:description>
                        <div>This will cause unusual problems on the
                            ...
                            <a class="underline" href='https://bedrock.io/docs/knowledge-base/server/firewall'
                                target='_blank'>required ports</a> or get
                            help on <a class="underline" href='https://bedrock.cloud/discord' target='_blank'>Discord</a>.
                        </div>
                    </x-slot:description>
                ...
                <x-slot:customActions>
                    <div
                        ...
                        <div class="flex flex-col gap-2 lg:px-10 px-1">
                            <div class="lg:text-xl text-md dark:text-white font-bold">Love Bedrock? Support our work.
                            </div>
