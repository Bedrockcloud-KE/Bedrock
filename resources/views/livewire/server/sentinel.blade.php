<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Sentinel | Bedrock
    </x-slot>
                                ...
                                <x-slide-over fullScreen>
                                    ...
                                    <x-slot:content>
                                        <livewire:project.shared.get-logs :server="$server"
                                            container="bedrock-sentinel" displayName="Sentinel" :collapsible="false"
                                            lazy />
                                    </x-slot:content>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    @if ($server->isSentinelEnabled())
                        ...
                        <x-forms.input canGate="update" :canResource="$server" id="sentinelCustomUrl" required
                            label="Bedrock URL"
                            helper="URL to your Bedrock instance. If it is empty that means you do not have a FQDN set for your Bedrock instance." />
